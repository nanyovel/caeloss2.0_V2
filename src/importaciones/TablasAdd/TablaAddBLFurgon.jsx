...
//     const thisItem = furgonIndicado.materiales[indexDataset];
...
//       ...prevState,
//       materiales: prevState.materiales.map((item, i) => {
//         if (i === indexDataset) {
//           return {
//             ...item,
...
//     // return;
//     let proceder = true;
//     furgonIndicado.materiales.forEach((item, index) => {
//       const qtyDisponible = calcularCantidadDisponible(
...
//     // Si no hay item
//     if (furgonIndicado.materiales.length == 0) {
...
//     const materialesCargarParsed = furgonIndicado.materiales.map((item) => {
//       return {
//         ...item,
//       };
//     });
//     if (accion == "addBL") {
//       setFurgonesMasterEditable([...furgonesMasterEditable, furgonIndicado]);
...
//     const materialesFiltrados = furgonIndicado.materiales.filter(
//       (item, indexCopia) => {
...
//   // Esto es adaptaciones para carga sueltas
//   const [listaMateriales, setListaMateriales] = useState([]);
//   useEffect(() => {
//     console.log(opcionTipoBL);
//     const opcionFind = opcionTipoBL.find((opcion) => opcion.select);
//     if (opcionFind.code == "normal") {
//       setListaMateriales(furgonIndicado.materiales);
//     } else if (opcionFind.code == "cargaSuelta") {
//       setListaMateriales(materialesSueltos);
//     }
//   }, [opcionTipoBL, furgonIndicado, materialesSueltos]);
//   return (
//     <>
//       <BotonQuery
