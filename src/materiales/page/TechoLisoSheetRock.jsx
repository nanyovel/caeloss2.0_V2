...
export const TechoLisoSheetRock = () => {
  useEffect(() => {
    document.title = "Caeloss - Techo Sheetrock";
  ...
  const functFormulas = (objeto) => {
    ...
    const formulas = [
      ...
      {
        descripcion: "Lija N°100",
        formular: Math.ceil(objeto.area / 20),
      },
      {
        descripcion: "Fulminantes",
