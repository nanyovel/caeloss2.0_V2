...
import { statusPagosReq } from "../schemas/mixSchema";
import { StyleTextStateReq } from "../libs/DiccionarioNumberString";

export default function ReportVenta({ datos }) {
  return (
    <>
      <CajaTabla>
        <Tabla>
            ...
            {datos.map((req, index) => {
              return (
                ...
                >
                  ...
                  <CeldasBody className="startText estandar">
                  ...
                  <CeldasBody>
                    {StyleTextStateReq.find(
                      (state, index) => state.numero == req.estadoDoc
                    )?.texto || "default"}
                  </CeldasBody>
                </Filas>
              );
