...
class Habitaciones{
  constructor(plancha4x8,paral60cm,paral40cm,durmientes,keraflor, tornilloPlancha, tornilloEstructura,cinta300,fulminantes,clavoYeso,ancho,largo){
...
let cuarto = [];
cuarto.push(habitacion0);
cuarto.push(habitacion1);
cuarto.push(habitacion2);
cuarto.push(habitacion3);
cuarto.push(habitacion4);
cuarto.push(habitacion5);
cuarto.push(habitacion6);
cuarto.push(habitacion7);
cuarto.push(habitacion8);
cuarto.push(habitacion9);
cuarto.push(habitacion10);
