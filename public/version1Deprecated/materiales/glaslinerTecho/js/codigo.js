...
function agrearHabitacion(){
  ...
  for(i=1;i<padre_encabezado.childElementCount-2;i++){
    cajaCeldaE[i].innerHTML = na;
    // padre_celdaH.classList.add("desactivar");
    cajaCeldaF[i].innerHTML = na;
    cajaCeldaF[i].classList.add("desactivar");
    cajaCeldaE[i].classList.add("desactivar");
  }
}
...
class Habitaciones{
  constructor(plancha4x10,pegamentoFrp,remateTop,barraDivisoria,esquineroInterior, esquineroExterior,siliconClear,tarugosGrandes, tarugosPequeno,ancho,largo){
    this.plancha4x10 = plancha4x10;
    this.pegamentoFrp = pegamentoFrp;
    this.remateTop = remateTop;
    this.barraDivisoria = barraDivisoria;
    this.esquineroInterior = esquineroInterior;
    this.esquineroExterior = esquineroExterior;
    this.siliconClear = siliconClear;
    this.tarugosGrandes = tarugosGrandes;
    this.tarugosPequeno = tarugosPequeno;
    this.ancho = ancho;
    this.largo = largo;
  }
  area2(){
...
let esqInterna = document.getElementById('esqInterna');
let esqExterna = document.getElementById('esqExterna');
...
function calcular(){
  ...
  for(i=0;i<ancho_habitacion.length;i++){
    console.log(i);
    console.log(ancho_habitacion.length);
    o=i+1;
    ...
    cuarto[i].plancha4x10 = cuarto[i].ancho/1.22;
    cuarto[i].plancha4x10 = Math.ceil(cuarto[i].plancha4x10);

    cuarto[i].pegamentoFrp = metros2 /16;
    cuarto[i].pegamentoFrp = parseFloat(cuarto[i].pegamentoFrp);
    cuarto[i].pegamentoFrp = cuarto[i].pegamentoFrp.toFixed(2);
    cuarto[i].pegamentoFrp = parseFloat(cuarto[i].pegamentoFrp);

    cuarto[i].remateTop = metrosL /3.05;
    cuarto[i].remateTop = parseFloat(cuarto[i].remateTop);
    cuarto[i].remateTop = cuarto[i].remateTop.toFixed(2);
    cuarto[i].remateTop = parseFloat(cuarto[i].remateTop);

    cuarto[i].barraDivisoria = (Math.ceil(cuarto[i].ancho/1.22))-1;
    cuarto[i].barraDivisoria = cuarto[i].barraDivisoria*cuarto[i].largo;
    cuarto[i].barraDivisoria = cuarto[i].barraDivisoria/3.05;
    cuarto[i].barraDivisoria = parseFloat(cuarto[i].barraDivisoria);
    cuarto[i].barraDivisoria = cuarto[i].barraDivisoria.toFixed(2);
    cuarto[i].barraDivisoria = parseFloat(cuarto[i].barraDivisoria);

    cuarto[i].siliconClear = (cuarto[i].remateTop+cuarto[i].barraDivisoria)/10;
    cuarto[i].siliconClear = parseFloat(cuarto[i].siliconClear);
    cuarto[i].siliconClear = cuarto[i].siliconClear.toFixed(2);
    cuarto[i].siliconClear = parseFloat(cuarto[i].siliconClear);

    cuarto[i].tarugosGrandes = metros2 *5;
    cuarto[i].tarugosGrandes = Math.ceil(cuarto[i].tarugosGrandes);

    cuarto[i].tarugosPequeno = metros2*5;
    cuarto[i].tarugosPequeno = Math.ceil(cuarto[i].tarugosPequeno);

    imprimirDato(cajaCeldaA[o], cuarto[i].plancha4x10);
    imprimirDato(cajaCeldaB[o], cuarto[i].pegamentoFrp);
    imprimirDato(cajaCeldaC[o], cuarto[i].remateTop);
    imprimirDato(cajaCeldaD[o], cuarto[i].barraDivisoria);
  ...
  function sumarHabitaciones(){
    totalHab.plancha4x10 =0;
    totalHab.pegamentoFrp =0;
    totalHab.remateTop=0;
    totalHab.barraDivisoria =0;
    ...
    for(i=0; i<ancho_habitacion.length; i++){
      ...
      totalHab.plancha4x10 += cuarto[i].plancha4x10;
      totalHab.pegamentoFrp += cuarto[i].pegamentoFrp;
      totalHab.remateTop+= cuarto[i].remateTop;
      totalHab.barraDivisoria += cuarto[i].barraDivisoria;
    ...
    totalHab.esquineroExterior = esqExterna.value / 3.05;
    totalHab.esquineroExterior = parseFloat(totalHab.esquineroExterior);
    totalHab.esquineroExterior = totalHab.esquineroExterior.toFixed(2);
    totalHab.esquineroExterior = parseFloat(totalHab.esquineroExterior);

    totalHab.esquineroInterior = esqInterna.value / 3.05;
    totalHab.esquineroInterior = parseFloat(totalHab.esquineroInterior);
    totalHab.esquineroInterior = totalHab.esquineroInterior.toFixed(2);
    totalHab.esquineroInterior = parseFloat(totalHab.esquineroInterior);

    totalHab.pegamentoFrp = Math.ceil(totalHab.pegamentoFrp);
    totalHab.remateTop= Math.ceil(totalHab.remateTop);
    totalHab.barraDivisoria =Math.ceil(totalHab.barraDivisoria);
    ...
    for(i=0;i<ancho_habitacion.length;i++){
      ...
      imprimirDato(cajaCeldaA[0], totalHab.plancha4x10);
      imprimirDato(cajaCeldaB[0], totalHab.pegamentoFrp);
      imprimirDato(cajaCeldaC[0], totalHab.remateTop);
      imprimirDato(cajaCeldaD[0], totalHab.barraDivisoria);
